...
-- Started on 2024-01-24 21:54:26 UTC
...
--
-- TOC entry 3477 (class 0 OID 16483)
-- Dependencies: 230
-- Data for Name: meal_entries; Type: TABLE DATA; Schema: public; Owner: docker
--

COPY public.meal_entries (entry_id, user_id, meal_type_id, product_id, unit_id, amount) FROM stdin;
11	2	1	6	3	4.00
\.


--
-- TOC entry 3475 (class 0 OID 16474)
-- Dependencies: 228
-- Data for Name: meal_types; Type: TABLE DATA; Schema: public; Owner: docker
--

COPY public.meal_types (meal_type_id, meal_type_name) FROM stdin;
1	breakfast
2	lunch
3	dinner
4	snacks
...
--
-- TOC entry 3473 (class 0 OID 16458)
-- Dependencies: 226
-- Data for Name: product_units; Type: TABLE DATA; Schema: public; Owner: docker
--

COPY public.product_units (product_id, unit_id, calories_per_unit) FROM stdin;
2	2	150
2	3	100
3	1	150
3	3	120
...
--
-- TOC entry 3479 (class 0 OID 16519)
-- Dependencies: 232
-- Data for Name: reward_types; Type: TABLE DATA; Schema: public; Owner: docker
--

COPY public.reward_types (reward_type_id, type_name) FROM stdin;
1	discount code
2	profile picture
3	recipe
\.
...
-- Dependencies: 234
-- Data for Name: rewards; Type: TABLE DATA; Schema: public; Owner: docker
--

COPY public.rewards (reward_id, required_level, reward_type_id, content) FROM stdin;
1	1	1	WorkH4rd
2	2	2	mage
3	3	1	Do1ngGood
4	4	2	assassin
...
--
-- TOC entry 3472 (class 0 OID 16452)
-- Dependencies: 225
-- Data for Name: units; Type: TABLE DATA; Schema: public; Owner: docker
--
...
--
-- TOC entry 3466 (class 0 OID 16417)
-- Dependencies: 219
-- Data for Name: user_details; Type: TABLE DATA; Schema: public; Owner: docker
--

COPY public.user_details (user_id, level, exp, profile_image_name, height, current_weight, weight_loss, activity_level, sex, age) FROM stdin;
7	1	25	knight	0	0.00	0	zero	m	20
3	1	25	knight	185	92.30	3	medium	f	24
2	5	50	assassin	179	71.00	1	zero	m	23
\.
...
COPY public.users (user_id, login, email, password, salt, enabled, role_id) FROM stdin;
2	u11	myemail@docker.com	$2y$10$fgiWqK8PUKO2tZaQwA3U2OxIZ5CVbitseaCZW1s4vUJPVcyG/npH2	035eb27893650547619b8df6a3bfed6e	t	2
7	u22	u22@gmail.com	$2y$10$1TBADzpuGQrEafv34UHAaef57lfBZxQzvFcZzyvWlj0I0Wbf8YyFy	d4daa95f5497ec7d9f7194cadeff895b	t	2
3	admin1	adminemail@admin.com	$2y$10$Sr8Flo2r5Bn7EYVsvTLdYuQ3iI8XosoMRd/0FzZJIw7AYHFF7UGSm	2024bcd8c7cd48a6d08cc3264a3f13e9	t	1
\.
...
-- Dependencies: 221
-- Data for Name: weight_changes; Type: TABLE DATA; Schema: public; Owner: docker
--

COPY public.weight_changes (change_id, user_id, change_date, new_weight) FROM stdin;
2	2	2024-01-02	79.20
3	2	2024-01-08	77.20
4	2	2024-01-14	74.10
5	2	2024-01-19	73.90
1	2	2024-01-24	71.00
\.
...
-- Dependencies: 229
-- Name: meal_entries_entry_id_seq; Type: SEQUENCE SET; Schema: public; Owner: docker
--

SELECT pg_catalog.setval('public.meal_entries_entry_id_seq', 11, true);


--
-- TOC entry 3497 (class 0 OID 0)
-- Dependencies: 227
-- Name: meal_types_meal_type_id_seq; Type: SEQUENCE SET; Schema: public; Owner: docker
--

SELECT pg_catalog.setval('public.meal_types_meal_type_id_seq', 5, true);


--
-- TOC entry 3498 (class 0 OID 0)
-- Dependencies: 222
-- Name: products_product_id_seq; Type: SEQUENCE SET; Schema: public; Owner: docker
--
...
-- Dependencies: 231
-- Name: reward_types_reward_type_id_seq; Type: SEQUENCE SET; Schema: public; Owner: docker
--

SELECT pg_catalog.setval('public.reward_types_reward_type_id_seq', 3, true);


--
-- TOC entry 3500 (class 0 OID 0)
-- Dependencies: 233
-- Name: rewards_reward_id_seq; Type: SEQUENCE SET; Schema: public; Owner: docker
--

SELECT pg_catalog.setval('public.rewards_reward_id_seq', 9, true);
...
-- Dependencies: 224
-- Name: units_unit_id_seq; Type: SEQUENCE SET; Schema: public; Owner: docker
--
...
-- Dependencies: 220
-- Name: weight_changes_change_id_seq; Type: SEQUENCE SET; Schema: public; Owner: docker
--

SELECT pg_catalog.setval('public.weight_changes_change_id_seq', 6, true);
...
-- Completed on 2024-01-24 21:54:26 UTC
