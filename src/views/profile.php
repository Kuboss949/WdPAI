...
<div class="profile-grid">
    <div class="change-icon flex">
        <div class = "profile-icon">
            <img id="profileImage" alt="profile-image" src = "../../public/images/profilePictures/<?php echo $userObject->getImage(); ?>.png">
        </div>
    </div>
    ...
    <div class = "profile-settings flex">
        ...
        <form id="profile-settings-form" method="POST" action="profile">
            <div class="floating-label">
                ...
                <input value=<?php echo $userObject->getLogin(); ?> class="form-field" type="text" name="login" placeholder="U1">
            </div>
            <div class="floating-label">
    ...
    <div class = "goals-settings flex">
        ...
        <form id="goals-settings-form" method="POST" action="profile">
            ...
            <div class="floating-label">
                ...
                <div class="input-with-unit">
                    <input value=<?php echo $userObject->getAge(); ?> class="form-field" type="text" name="age" placeholder="20">
            ...
            <div class="floating-label">
                ...
                <select class="form-field" name="weekly-activity">
                    ...
                    <option value="medium" <?= ($userObject->getActivity() == 'medium') ? 'selected' : '' ?>>Medium</option>
